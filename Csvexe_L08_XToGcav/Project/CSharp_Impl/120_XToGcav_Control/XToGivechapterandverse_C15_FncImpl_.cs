...
namespace Xenon.XToGcav
{
    ...
    class XToConfigurationtree_C15_FncImpl_ : XToConfigurationtree_C_Parser15Impl
    {
            ...
            )
        {
            ...
            log_Method.BeginMethod(Info_XToGcav.Name_Library, this, "CreateMyself",log_Reports);
            ...
            XmlElement cur_X, Configurationtree_Node cur_Cf, Log_Reports log_Reports)
        {
            ...
            log_Method.BeginMethod(Info_XToGcav.Name_Library, this, "Test_ChildNodes",log_Reports);
