...
namespace Xenon.Functions
{
    ...
    public class GivechapterandverseToFunction20_ItemImpl : GivechapterandverseToFunction00_ItemImpl
    {
            ...
            )
        {
            ...
            parent_Expr_Func.TrySelectAttr(out ec_ArgListboxName, Expression_Node_Function20Impl.S_PM_NAME_FC_LST, false, Request_SelectingImpl.Unconstraint, log_Reports);
            ...
            if ("" == ec_ArgListboxName.Execute_OnExpressionString(Request_SelectingImpl.Unconstraint, log_Reports))
            {
                ...
                if (log_Reports.BSuccessful)
                {
                    ...
                    parent_Givechapterandverse_Control.Dictionary_SAttribute_Givechapterandverse.TryGetValue(PmNames.S_NAME, out sName_Usercontrol, true, log_Reports);
