...
namespace Xenon.Functions
{
    ...
    public class Expression_Node_Function46Impl : Expression_Node_FunctionAbstract
    {
        ...
        public static readonly string S_ACTION_NAME = "Sf:CSV書出し_フォーム;";
            ...
            object/*MemoryApplication*/ owner_MemoryApplication, Log_Reports log_Reports)
        {
            ...
            Expression_Node_Function f0 = new Expression_Node_Function46Impl(this.EnumEventhandler,this.ListS_ArgName,this.Functiontranslatoritem);
            ...
            f0.DicExpression_Attr.Set(Expression_Node_Function46Impl.S_PM_MESSAGE, new Expression_Node_StringImpl(this, cur_Gcav), log_Reports);
            ...
            )
        {
            ...
            Givechapterandverse_Node cur_Cf = new Givechapterandverse_NodeImpl(log_Method.SHead, null);
            ...
            // 変数ログを吐く。
            {
                ...
                {
                    //uct_Child.ControlCommon.Givechapterandverse_Control.Dictionary_SAttribute_Givechapterandverse.
                    ...
                    sb.Append(NamesFld.S_FILE);//FILE
                    sb.Append(",");
                    sb.Append(uct_Child.ControlCommon.Givechapterandverse_Control.SName);//NAME
                    sb.Append(",");
                    sb.Append(NamesFld.S_TYPE);//TYPE
                    sb.Append(",");
                ...
                //ログ出力
                {
                    ...
                    string sFpatha_LogVariables = ec_Fpath_Logs.Execute_OnExpressionString(Request_SelectingImpl.Unconstraint, log_Reports) + System.IO.Path.DirectorySeparatorChar + NamesFile.S_LOG_FORM;
            ...
            //変数CSVを吐き出したい。（登録されている順序を保って）
            {
                ...
                if (null != o_Table_Variables)
                {
                    ...
                    //ファイル書出し
                    {
                        ...
                        string sFpatha_LogVariables = ec_Fpath_Logs.Execute_OnExpressionString(Request_SelectingImpl.Unconstraint, log_Reports) + System.IO.Path.DirectorySeparatorChar + NamesFile.S_SAVE_FORM;
            ...
            // メッセージボックスの表示。
            {
                ...
                sb.Append(Environment.NewLine);
                string sArgMessage;
                this.TrySelectAttr(out sArgMessage, Expression_Node_Function46Impl.S_PM_MESSAGE, false, Request_SelectingImpl.Unconstraint, log_Reports);
