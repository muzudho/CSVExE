...
namespace Xenon.Functions
{
    ...
    public class Expression_Node_Function46Impl : Expression_Node_FunctionAbstract
    {
            ...
            object/*MemoryApplication*/ owner_MemoryApplication, Log_Reports pg_Logging)
        {
            ...
            f0.DicExpression_Attr.Set(Expression_Node_Function46Impl.S_PM_MESSAGE, new Expression_Node_StringImpl(this, cur_Gcav), pg_Logging);
            ...
            )
        {
            ...
            // 変数ログを吐く。
            {
                ...
                //ログ出力
                {
                    ...
                    string sFpatha_LogVariables = ec_Fpath_Logs.Execute_OnExpressionString(Request_SelectingImpl.Unconstraint, pg_Logging) + System.IO.Path.DirectorySeparatorChar + NamesFile.S_LOG_FORM;
            ...
            //変数CSVを吐き出したい。（登録されている順序を保って）
            {
                ...
                if (null != o_Table_Variables)
                {
                    ...
                    //ファイル書出し
                    {
                        ...
                        string sFpatha_LogVariables = ec_Fpath_Logs.Execute_OnExpressionString(Request_SelectingImpl.Unconstraint, pg_Logging) + System.IO.Path.DirectorySeparatorChar + NamesFile.S_SAVE_FORM;
            ...
            // メッセージボックスの表示。
            {
                ...
                sb.Append(Environment.NewLine);
                string sArgMessage;
                this.TrySelectAttr(out sArgMessage, Expression_Node_Function46Impl.S_PM_MESSAGE, false, Request_SelectingImpl.Unconstraint, pg_Logging);
