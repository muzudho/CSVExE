...
namespace Xenon.Functions
{
    public class Expression_Node_Function28Impl : Expression_Node_FunctionAbstract
    {
            ...
            object/*MemoryApplication*/ owner_MemoryApplication, Log_Reports log_Reports)
        {
            ...
            f0.Dictionary_Expression_Attribute.Set(Expression_Node_Function28Impl.S_PM_MESSAGE, new Expression_Node_StringImpl(this, cur_Gcav), log_Reports);
            ...
            )
        {
            ...
            string sArgMessage;
            this.TrySelectAttribute(out sArgMessage, Expression_Node_Function28Impl.S_PM_MESSAGE, false, Request_SelectingImpl.Unconstraint, log_Reports);
