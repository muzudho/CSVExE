...
namespace Xenon.Functions
{
    public class Expression_Node_Function39Impl : Expression_Node_FunctionAbstract
    {
        ...
        public static readonly string S_ACTION_NAME = "Sf:活性化;";
        ...
        public Expression_Node_Function39Impl(EnumEventhandler enumEventhandler, List<string> listS_ArgName, GivechapterandverseToFunction_Item functiontranslatoritem)
            ...
            object/*MemoryApplication*/ owner_MemoryApplication, Log_Reports pg_Logging)
        {
            ...
            f0.DicExpression_Attr.Set(Expression_Node_Function39Impl.S_PM_NAME_FC, new Expression_Node_StringImpl(this, cur_Gcav), pg_Logging);
            f0.DicExpression_Attr.Set(Expression_Node_Function39Impl.S_PM_VALUE_ENABLED, new Expression_Node_StringImpl(this, cur_Gcav), pg_Logging);
            ...
            )
        {
...

            {
                ...
                this.TrySelectAttr(out ec_ArgFcName, Expression_Node_Function39Impl.S_PM_NAME_FC, false, Request_SelectingImpl.Unconstraint, pg_Logging);
                ...
                if (pg_Logging.BSuccessful)
                {
                    ...
                    string sValue;
                    this.TrySelectAttr(out sValue, Expression_Node_Function39Impl.S_PM_VALUE_ENABLED, false, Request_SelectingImpl.Unconstraint, pg_Logging);
