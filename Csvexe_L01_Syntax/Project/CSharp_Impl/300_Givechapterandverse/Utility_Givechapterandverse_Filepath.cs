...
{
    public abstract class Utility_Givechapterandverse_Filepath
    {
        ...
        public static string GetAbsolutefilepathimpl(
            Givechapterandverse_Filepath fpath_Gcav,
            ref bool bFlagCheckPathTooLong,
            bool bOkPathTooLong,
            Log_Reports log_Reports
            )
            ...
            )
        {
            ...
            // 「絶対パス」か、「相対パス」かを判断します。
            bool bPathRooted = Utility_Givechapterandverse_Filepath.IsRooted_Path(
                sFpath_Src,
                log_Reports
                );
        ...
        {
            return Utility_Givechapterandverse_Filepath.IsPathTooLong(
                "",
