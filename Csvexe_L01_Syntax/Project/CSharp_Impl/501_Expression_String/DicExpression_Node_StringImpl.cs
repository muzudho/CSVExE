...
namespace Xenon.Syntax
{
    ...
    /// 
    /// </summary>
    public class DicExpression_Node_StringImpl : DicExpression_Node_String
    {
        ...
        /// コンストラクター。
        /// </summary>
        public DicExpression_Node_StringImpl(Givechapterandverse_Node owner_Gcav)
        {
            ...
            )
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Givechapterandverse_Node parent_Gcav = new Givechapterandverse_NodeImpl("!ハードコーディング_NStringDictionaryImpl#Get", null);
        ...
        private Givechapterandverse_Node owner_Gcav;

        /// <summary>
        /// このオブジェクトを持つ、オブジェクト。
        /// </summary>
        public Givechapterandverse_Node Owner_Gcav
        {
            get
            {
                return owner_Gcav;
