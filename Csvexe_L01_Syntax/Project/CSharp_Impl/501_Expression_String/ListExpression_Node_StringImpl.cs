...
namespace Xenon.Syntax
{
    ...
    /// 
    /// </summary>
    public class ListExpression_Node_StringImpl : ListExpression_Node_String
    {
        ...
        /// コンストラクター。
        /// </summary>
        public ListExpression_Node_StringImpl(Expression_Node_String owner)
        {
        ...
        public void ToText_Snapshot(Log_TextIndented txt)
        {
            ...
            {
                ec_Item.Cur_Givechapterandverse.ToText_Content(txt);
            }
            ...
            )
        {
            ...
            else if (ec_Child is Expression_P1pImpl)
            {
                ((Expression_P1pImpl)ec_Child).Parent_Expression = this.owner_Expression;
            }
            else
            {
