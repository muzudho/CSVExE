...
namespace Xenon.MiddleImpl
{
    ...
    public class MemoryTablesImpl : MemoryTables
    {
            ...
            )
        {
            ...
            try
            {
                string str_KeyExpected = expr_KeyExpected.Execute_OnExpressionString(Request_SelectingImpl.Unconstraint, log_Reports);
        ...
        gt_Error_NotFound:
            if (log_Reports.CanCreateReport)
            {
                ...
                t.Append(expr_KeyExpected.Execute_OnExpressionString(Request_SelectingImpl.Unconstraint, log_Reports));
            ...
            )
        {
            ...
            try
            {
                str_KeyExpected = expr_KeyExpected.Execute_OnExpressionString(Request_SelectingImpl.Unconstraint, log_Reports);
                foreach (XenonTable xenonTable in this.dictionary_XenonTable.Values)
                {
