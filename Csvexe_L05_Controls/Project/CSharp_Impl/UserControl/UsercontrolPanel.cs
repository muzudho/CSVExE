...
namespace Xenon.Controls
{
    ...
    /// 
    /// FC_main_mainWnd で作られることもあります。
    /// </summary>
    public partial class UsercontrolPanel : UserControl, Usercontrol
    {
        ...
        gt_Error_NotSupportedEvent:
            {
                ...
                tmpl.SetParameter(3, Log_RecordReportsImpl.ToText_Configurationtree(sToE_Event.Configurationtree_Event), log_Reports);//設定位置パンくずリスト

                this.ControlCommon.Owner_MemoryApplication.CreateErrorReport("Er:521;", tmpl, log_Reports);
            }
            goto gt_EndMethod;
        //────────────────────────────────────────
            #endregion
        ...
        private CustomcontrolPanel customcontrolPanel1;

        /// <summary>
        /// パネルを改造した、ＣＳＶＥｘＥ用カスタム・コントロール。
        /// 
        /// 更にこの中に、画像フォーム（PictureBox）が乗っている。
        /// </summary>
        public CustomcontrolPanel CustomcontrolPanel1
        {
            get
            {
                return this.customcontrolPanel1;
            }
        }
