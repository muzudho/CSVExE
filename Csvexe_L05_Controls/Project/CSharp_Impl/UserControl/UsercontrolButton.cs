    ...
    public partial class UsercontrolButton : UserControl, Usercontrol
    {
            ...
            )
        {
...

            {
                ...
                {
                    // フォント・サイズの設定
                    float fontSizePt = Utility_Usercontrol.ParseFontSize(fo_Record, log_Reports);
        ...
        public event EventHandler UsercontroleventhandlerClick
        {
            add
            {
                //this.ccButton.NCount_EventHandler_Click++;
        ...
        public Expression_Node_String Expression_Name_Control
        {
            set
            {
                ...
                if (null == value)
                {
                    ...
                    Givechapterandverse_Node s_Node = new Givechapterandverse_NodeImpl(Info_Controls.SName_Library + ":" + this.GetType().Name + "#<init>:" + this.Name, null);
