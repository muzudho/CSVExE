...
namespace Xenon.Controls
{
    ...
    public partial class UsercontrolListbox : UserControl, Usercontrol
    {
            ...
            )
        {
            ...
            // 【特殊】リストボックスの場合
            int nItemHeightPx;
            fo_Record.TryGetInt(out nItemHeightPx, NamesFld.S_ITEM_HEIGHT_PX, false, UsercontrolListbox.N_DEFAULT_ITEM_HEIGHT_PX, log_Reports);
            ...
            fo_Record.TryGetString(out sItemDisplayFormat, NamesFld.S_ITEM_DISPLAY_FORMAT, false, "", log_Reports);
            this.CustomcontrolListbox1.SItemDisplayFormat = sItemDisplayFormat;

            // 【特殊】リストボックスの場合
            string sListValueField;
            fo_Record.TryGetString(out sListValueField, NamesFld.S_LIST_VALUE_FIELD, false, "", log_Reports);
